    ...
    : WebApplicationFactory<ApiAssemblyMarker>
{
    ...
    private static Dictionary<string, string?> DefaultSettings() => new()
    {
        ...
        ["DropShield:OriginAssertions:Enabled"] = "false",
        ["DropShield:OriginAssertions:HeaderName"] = "X-DropShield-Origin-Assertion",
        ["DropShield:OriginAssertions:LifetimeSeconds"] = "20",
        ["DropShield:OriginAssertions:KeyId"] = "primary",
        ["DropShield:OriginAssertions:SigningKey"] = "",
